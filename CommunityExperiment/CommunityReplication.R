# Replicate the analyses of the community experiment (Mummolo and Nall 2016)
# using the ACP framework (Ganter 2021)
# Author: Flavien Ganter
# Created on February 23, 2021; last modified on February 23, 2021
...
# Import
load("conj.data.party.RData") ### specify data (available on https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/EDGRDC)

# Select relevant variables
data_long <- conj.data.party[!is.na(conj.data.party$response),
                             c("partywlean", "respid", "task", "conj.school", "conj.place", "response")]
